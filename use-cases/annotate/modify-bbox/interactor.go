...
func (i *Interactor) Execute(r Request, out OutputPort) {
	...
	if ok := i.update(r.AnnotationId, *u, out); !ok {
		return
	}
...
func (i *Interactor) update(id a.AnnotationId, u a.BoundingBoxUpdatables, out OutputPort) bool {
...
func (i *Interactor) validate(id a.AnnotationId, xc float32, yc float32, width float32,
	height float32, label lbl.Label, out OutputPort) (*a.BoundingBoxUpdatables, bool) {

	if err := a.ValidateBoundingBox(xc, yc, width, height); err != nil {
		out.ErrValidation(err)
		return nil, false
	}
	return &a.BoundingBoxUpdatables{LabelId: label.Id, Xc: xc, Yc: yc, Width: width, Height: height}, true
